    ...
    public class RelatorioTotal
    {
        public void GerarPDF(DataGridView dgv)
        {
            try
            {
                ...
                salvar.FileName = $"Relatorio_Support_{DateTime.Now:dd-MM-yyyy}.pdf";
                ...
                Paragraph titulo = new Paragraph("Relatório de Chamados - HelpDesk Pro - Support\n\n",
                ...
                MessageBox.Show("Relatório Support gerado com sucesso!", "Sucesso",
                    MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
